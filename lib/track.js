...
module.exports = class TrackClient {
  constructor(siteid, apikey, defaults = {}) {
    ...
    this.trackRoot = this.defaults.url ? this.defaults.url : trackRoot[this.defaults.region];
    this.apiRoot = this.defaults.apiUrl ? this.defaults.apiUrl : apiRoot[this.defaults.region];
  }
